const timelineEvents = [
  {
    ...
    title: "Budi Utomo",
    shortDescription:
      "Organisasi pergerakan nasional pertama yang menandai kebangkitan nasional Indonesia.",
    fullDescription: `
        ...
        `,
    image:
      "https://static.promediateknologi.id/crop/0x0:0x0/0x0/webp/photo/p2/65/2024/05/20/17-2709242067.jpg",
    ...
    relatedHeroes: [
      {
        ...
        image:
          "https://thephrase.s3.ap-southeast-1.amazonaws.com/2022/05/dr-Soetomo-dr-Sutomo.jpg",
      },
    ],
  },

  {
    ...
    title: "Sarekat Islam",
    shortDescription:
      "Organisasi massa pertama yang memperjuangkan hak-hak rakyat Indonesia.",
    fullDescription: `
        ...
        `,
    image:
      "https://img.inews.co.id/media/620/files/inews_new/2023/07/08/tokoh_sarekat_islam.jpg",
    ...
    relatedHeroes: [
      {
        ...
        image:
          "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRW4eT2PHllw5D8gWxpBGk59HRziOkM-RWsEg&s",
      },
    ],
  },
  {
    ...
    title: "Sumpah Pemuda",
    shortDescription:
      "Ikrar pemuda Indonesia yang menyatukan bahasa, bangsa, dan tanah air.",
    fullDescription: `
        ...
        `,
    image:
      "https://edoo.id/wp-content/uploads/2023/10/Fakta-Menarik-Sumpah-Pemuda-1.jpg",
    ...
    relatedHeroes: [
      {
        ...
        image:
          "https://campusnet.news/wp-content/uploads/2024/10/Prof-Moh-Yamin.jpg",
      },
    ],
  },
  {
    ...
    shortDescription:
      "Pembacaan teks Proklamasi yang menandai kemerdekaan Indonesia.",
    fullDescription: `
        ...
        `,
    image:
      "https://akcdn.detik.net.id/community/media/visual/2020/08/18/proklamasi-kemerdekaan.jpeg?w=700&q=90",
    ...
    relatedHeroes: [
      {
        ...
        image:
          "https://lh3.googleusercontent.com/bLmgPZ4gDJxS4LKirKeMHgiBlBS2j_u1oSyGtnhorHhLqR93S2prtYjWZzGTJ1Pg4X4tB8NrHKFsiCmR2xut7imfzrXBHEg4_n5I6aXxZW4sTp2oc8CnvM1FQV33VXgAR7tmf3kVqg=w2400",
      },
      {
        name: "Mohammad Hatta",
        role: "Proklamator Kemerdekaan",
        image:
          "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSgWZsodCvRvz6MfNN29pCHvJGRwqR9l-Ke9g&s",
      },
    ],
  },
];
...
class TimelineManager {
  ...
  setupNavigation() {
    ...
    document
      ...
      .insertAdjacentHTML("beforeend", nav);
  ...
  toggleCard(event, dot) {
    if (
      this.activeCard &&
      this.activeCard.querySelector(".more-info-btn").dataset.eventId ===
        dot.dataset.eventId
    ) {
